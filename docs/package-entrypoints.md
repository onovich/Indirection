...
- Web, Three, and Vite packages are adapters around core contracts, not new sources of truth. Browser ImageBitmap handling belongs in loaders-web and reaches runtime only through `LoadedAsset.dispose`.
