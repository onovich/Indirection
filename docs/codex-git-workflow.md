...
<!-- initialized-at: 2026-06-20 19:24:21 +08:00 -->

# Codex Git Workflow

Initialization status: initialized
Project: Indirection
Repository root: D:/LabProjects/Engine/Indirection
...
```powershell
git -c safe.directory=D:/LabProjects/Engine/Indirection status --short --branch
```
...
```
powershell
git -c safe.directory=D:/LabProjects/Engine/Indirection push -u origin HEAD
```

## Docs And TODO

For architecture or protocol changes, update the relevant docs/ADR notes or state no doc update is needed.

## Safety And Branch Policy

No force-push; no destructive git commands without explicit user request.
